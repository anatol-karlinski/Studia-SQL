...
CREATE TABLE Adres
(
	idAdres INT NOT NULL IDENTITY(1,1) PRIMARY KEY,
...
(
	idLabolatorium INT NOT NULL IDENTITY(1,1) PRIMARY KEY,
	nazwa varchar(255),
	idAdres_FK INT UNIQUE FOREIGN KEY REFERENCES Adres(idAdres),
);
CREATE TABLE Fabryka
(
	idFabryka INT NOT NULL IDENTITY(1,1) PRIMARY KEY,
	nazwa varchar(255),
	idAdres_FK INT UNIQUE FOREIGN KEY REFERENCES Adres(idAdres),
);
CREATE TABLE DaneOsobowe
(
	idDaneOsobowe INT NOT NULL IDENTITY(1,1) PRIMARY KEY,
...
(
	idPracownik INT NOT NULL IDENTITY(1,1) PRIMARY KEY,
...
(
	idManager INT NOT NULL IDENTITY(1,1) PRIMARY KEY,
	idFabryka_FK INT NOT NULL UNIQUE FOREIGN KEY REFERENCES Fabryka(idFabryka),
	idDaneOsobowe_FK INT UNIQUE FOREIGN KEY REFERENCES DaneOsobowe(idDaneOsobowe),
);
CREATE TABLE Substancja
(
	idSubstancja INT NOT NULL IDENTITY(1,1) PRIMARY KEY,
...
CREATE TABLE Cennik
(
	idCennik INT NOT NULL IDENTITY(1,1) PRIMARY KEY,
...
CREATE TABLE Dealer
(
	idDealer INT NOT NULL IDENTITY(1,1) PRIMARY KEY,
...
CREATE TABLE Klient
(
	idKlient INT NOT NULL IDENTITY(1,1) PRIMARY KEY,
